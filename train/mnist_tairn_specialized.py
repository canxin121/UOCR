...
#针对性的训练1和7，使用的是官方mnist数据集
x_train, y_train,x_test, y_test = process_data(x_train, y_train,x_test, y_test,2,3,0.9,0.1)
...
# 加载已经训练好的模型参数
model.load_weights('models/_mnist_.h5')
...
model.save('models/_mnist_1_.h5')
# 在测试数据集上评估模型的性能
