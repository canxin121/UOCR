...
def setmatchoice(map):
    ...
    if map == '1':
        ...
        with open(r"C:\Users\Administrator\PycharmProjects\pythonProject\data\emnist\emnist-letters-mapping.txt") as f:
            lines = f.readlines()
        # 创建一个字典，将数字映射到字母
        mappings = {}
        for line in lines:
        ...
        with open(r"C:\Users\Administrator\PycharmProjects\pythonProject\data\emnist\emnist-byclass-mapping.txt") as f:
            lines = f.readlines()
        # 创建一个字典，将数字映射到字符
        mappings = {}
        for line in lines:
